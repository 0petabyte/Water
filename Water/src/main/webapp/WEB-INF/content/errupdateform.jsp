                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="single_contant_left padding-top-90 padding-bottom-90">
                                            <form action="update.do" id="formid" method="post" enctype="multipart/form-data">
                                                <div class="col-lg-8 col-md-8 col-sm-10 col-lg-offset-2 col-md-offset-2 col-sm-offset-1">
                                                <input type="hidden" name="e_num" value="${dto.e_num}">
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" name="ewriter" value="${dto.ewriter}" required="" >
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" name="etitle" placeholder="${dto.etitle}" required="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <textarea class="form-control" name="econtent" rows="10" placeholder="${dto.econtent}"></textarea>
                                                    </div>
