                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="single_contant_left padding-top-90 padding-bottom-90">
                                            <form action="fupdate.do" id="formid" method="post" enctype="multipart/form-data">
                                                <div class="col-lg-8 col-md-8 col-sm-10 col-lg-offset-2 col-md-offset-2 col-sm-offset-1">
                                                <input type="hidden" name="f_num" value="${dto.f_num}">
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" name="fwriter" value="${dto.fwriter}" required="" >
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" name="ftitle" placeholder="${dto.ftitle}" required="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <textarea class="form-control" name="fcontent" rows="10" placeholder="${dto.fcontent}"></textarea>
                                                    </div>
